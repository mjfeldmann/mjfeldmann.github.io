...
However, we have to keep in mind that the diffusion material must also be "true neutral" otherwise the color accuracy will be diminished even if the bulbs are perfect.
